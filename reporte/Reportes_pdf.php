...
//-----------------------------------------------------------------------------------------------
		public function pdf( $titulo = "Listado de usuarios de sisgad", $formato = 'A4' , $orientacion = 'P' , $html, $archivo = "Usuarios")
		{
			        ...
			        $pdf->SetCreator("PDVSA");
			        $pdf->SetTitle($titulo);
			       	$pdf->SetAuthor('PDVSA');
					$pdf->SetSubject('PDVSA');
					$pdf->SetKeywords('PDVSA');
