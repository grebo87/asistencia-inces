...
<link rel="stylesheet" type="text/css" href="Style_Buscar_Personal.css" media="screen" />
...
<th>
<a href="/SISTEMA/Inicio/Inicio.pho" title="Pagina de inicio"><img src="/SISTEMA/Imagenes_Sistema/inces.png" id="img_Logo_Escuela"></a>
</th>
<th>
...
<div id="contact">
 ...
 <form  action="/SISTEMA/Gestionar_Personal/Registro_De_Usuario/modificar.php" enctype="multipart/form-data" method="POST" name="formulario" id="formulario">
