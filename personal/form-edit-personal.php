...
<fieldset>
    ...
    <div class="row">
        <div class="col-md-6">
            ...
            <input type="text" id="cedula" name="cedula" class="form-control"  placeholder="Ej:27637377" readonly value="<?php echo $persona['cedula']; ?>" required />
        </div> 
    </div><br>
    ...
    <div class="row">
        <div class="col-md-6">
            ...
            <input type="reset" value="Borrar información" class="btn btn-default">
        </div> 
    </div><br>        
